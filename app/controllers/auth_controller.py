...
def login_controller():
    ...
    access_token, refresh_token, user_branches = auth_service.login_service(data)

    return jsonify({"access_token" : access_token, "refresh_token" : refresh_token, "user_branches" : user_branches, "success" : True}), 200
